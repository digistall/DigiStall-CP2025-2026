  ...
  <v-dialog v-model="visibleModel" max-width="900px" persistent>
    <v-card class="edit-modal">
      ...
      <v-card-actions class="pa-4">
        ...
        <v-btn color="primary" :loading="saving" @click="save"> Update Collector </v-btn>
      </v-card-actions>
      ...
      <v-snackbar v-model="showError" color="error" timeout="3000">
        ...
        Error updating collector. Please try again.
      </v-snackbar>
    </v-card>
  </v-dialog>
</template>

<script src="./EditCollectorDialog.js"></script>
<style scoped src="./EditCollectorDialog.css"></style>
