            ...
            <v-row dense>
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  ...
                  persistent-hint
                  :hint="
                    newStall.priceType === 'Fixed Price'
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  v-model="newStall.size"
                  :rules="[rules.required, validateSize]"
                  label="Size"
