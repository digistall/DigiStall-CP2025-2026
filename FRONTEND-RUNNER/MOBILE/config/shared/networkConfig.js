...
export const API_CONFIG = {
  ...
  MOBILE_ENDPOINTS: {
    ...
    FORGOT_PASSWORD_STORE_CODE: '/api/auth/store-reset-code',      // Store code generated by client (EmailJS)
    FORGOT_PASSWORD_SEND_CODE: '/api/auth/resend-reset-code',      // For backward compatibility (backend email)
