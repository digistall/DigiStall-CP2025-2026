...
export const getAllBranchManagers = async (req, res) => {
  let connection;
  try {
    console.log('ðŸ“‹ Getting all branch managers - Request received');
    ...
    console.log('ðŸ” Fetching branch managers with filters...');
    ...
    console.log('âœ… Found', managers.length, 'branch managers');
    ...
    console.log('ðŸ“Š Manager statistics:', stats[0]);
    ...
    console.error('âŒ Get all branch managers error:', error);
