...
export const updateBranchManager = async (req, res) => {
  let connection;
  try {
    console.log('ðŸ”§ Updating branch manager - Request received');
    ...
    console.log('ðŸ” Update validation:');
    ...
    // Validation
    if (!managerId) {
      console.log('âŒ Missing manager ID in URL params');
    ...
    console.log('ðŸ” Checking if manager exists:', managerId);
    ...
    if (existingManager.length === 0) {
      console.log('âŒ Manager not found:', managerId);
    ...
    if (finalUsername !== existingManager[0].manager_username) {
      ...
      if (usernameExists.length > 0) {
        console.log('âŒ Username already exists:', finalUsername);
        return res.status(400).json({
          success: false,
    ...
    if (finalBranchId) {
      console.log('ðŸ” Validating branch ID:', finalBranchId);
      ...
      if (branchExists.length === 0) {
        console.log('âŒ Branch not found:', finalBranchId);
        return res.status(404).json({
          success: false,
      ...
      console.log('âœ… Branch validated:', branchExists[0]);
    }
    ...
    console.log('ðŸ”„ Updating branch manager...');
    console.log('ðŸ“ Update fields:', updateFields.join(', '));
    ...
    console.log('âœ… Manager updated successfully, affected rows:', updateResult.affectedRows);
    ...
    console.log('ðŸ“Š Fetching updated manager data...');
    ...
    console.log('âœ… Updated manager data retrieved:', updatedManager[0]);
    ...
    console.error('âŒ Update branch manager error:', error);
