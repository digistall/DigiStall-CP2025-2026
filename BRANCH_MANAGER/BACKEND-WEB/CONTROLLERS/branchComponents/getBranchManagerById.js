...
export const getBranchManagerById = async (req, res) => {
  let connection;
  try {
    console.log('ðŸ” Getting branch manager by ID - Request received');
    ...
    console.log('ðŸ” Fetching manager data:', managerId);
    ...
    console.error('âŒ Get branch manager error:', error);
