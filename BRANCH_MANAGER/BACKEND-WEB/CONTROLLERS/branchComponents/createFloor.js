...
export const createFloor = async (req, res) => {
  ...
  if (userType === "business_manager") {
    ...
    try {
      ...
      console.error("âŒ Error getting branch for manager:", error);
    ...
    console.log("ðŸ” Employee permission check for floor creation:", {
      permissions,
      hasFloorsPermission,
    });
  ...
  try {
    ...
    console.log(`âœ… Floor created successfully by ${userType}:`, {
      floor_id,
      floor_number,
      floor_name,
      branch_id
    ...
    console.error("âŒ Create floor error:", err);
    res.status(500).json({ 
      success: false, 
