...
export const createBusinessOwnerWithSubscription = async (req, res) => {
  ...
  try {
    ...
    console.log('âœ… Business Owner created:', { email, generatedPassword });
    ...
    console.error('âŒ Error creating business owner:', error);
...
export const recordSubscriptionPayment = async (req, res) => {
  ...
  try {
    ...
    console.error('âŒ Error recording payment:', error);
    res.status(500).json({
      success: false,
...
export const getAllBusinessOwnersWithSubscription = async (req, res) => {
  ...
  try {
    ...
    console.error('âŒ Error fetching business owners:', error);
    res.status(500).json({
      success: false,
...
export const getBusinessOwnerSubscription = async (req, res) => {
  ...
  try {
    ...
    console.error('âŒ Error fetching subscription:', error);
    res.status(500).json({
      success: false,
...
export const getBusinessOwnerPaymentHistory = async (req, res) => {
  ...
  try {
    ...
    console.error('âŒ Error fetching payment history:', error);
    res.status(500).json({
      success: false,
