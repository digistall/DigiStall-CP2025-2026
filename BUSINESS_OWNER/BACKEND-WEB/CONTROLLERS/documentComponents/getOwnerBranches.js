...
export const getOwnerBranches = async (req, res) => {
  ...
  try {
    ...
    console.log('ðŸ” getOwnerBranches - User:', { userId, userType });
    ...
    console.log(`âœ… Found ${branches.length} branches for business owner ${userId}`);
    ...
    console.error('âŒ getOwnerBranches error:', error);
    res.status(500).json({
      success: false,
