...
export const extendAuctionTimer = async (req, res) => {
  ...
  try {
    ...
    console.log(`â° Extending auction ${auctionId} timer by ${additionalHours} hours`);
    ...
    console.log(`âœ… Auction timer extended. New end time: ${newEndTime}`);
    ...
    console.error('âŒ Extend auction timer error:', error);
    res.status(500).json({
      success: false,
...
export const cancelAuction = async (req, res) => {
  ...
  try {
    ...
    console.log(`âŒ Cancelling auction ${auctionId}`);
    ...
    console.log(`âœ… Auction cancelled for stall ${auction.stall_no}`);
    ...
    console.error('âŒ Cancel auction error:', error);
    res.status(500).json({
      success: false,
