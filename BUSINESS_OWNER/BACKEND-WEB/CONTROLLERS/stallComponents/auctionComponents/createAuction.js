...
export const createAuction = async (req, res) => {
  ...
  try {
    ...
    console.log(`ðŸº Creating auction for stall ${stallId} with ${durationHours} hours duration, starting at â‚±${startingPrice}`);
    ...
    console.log(`âœ… Auction created with ID ${result.insertId} for stall ${stall.stall_number}`);
    ...
    console.error('âŒ Create auction error:', error);
    res.status(500).json({
      success: false,
