...
export const createRaffle = async (req, res) => {
  ...
  try {
    ...
    console.log(`ðŸŽ¯ Creating raffle for stall ${stallId} with ${durationHours} hours duration`);
    ...
    console.log(`âœ… Raffle created with ID ${result.insertId} for stall ${stall.stall_no}`);
    ...
    console.error('âŒ Create raffle error:', error);
    res.status(500).json({
      success: false,
