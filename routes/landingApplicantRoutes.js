...
router.post("/stall-application", authLimiter, applicantController.createStallApplication); // POST /api/landing-applicants/stall-application - Submit complete stall application from landing page
router.post("/", authLimiter, applicantController.createApplicant); // POST /api/landing-applicants - Create new applicant
