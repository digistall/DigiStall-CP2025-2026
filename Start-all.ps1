...
if ($Help) {
    ...
    Write-Host "  Expo Go  -> Connects to LOCAL backend  (178.16.100.6:5001)" -ForegroundColor Gray
...
Write-Host "  - Expo Go (dev)  -> Local backend  (178.16.100.6:5001)" -ForegroundColor DarkGray
