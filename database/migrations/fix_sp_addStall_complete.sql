...
CREATE PROCEDURE `sp_addStall_complete`(
    ...
    IN p_stall_image VARCHAR(500),  -- Parameter kept for compatibility but not used
...
BEGIN
   ...
   BEGIN_LABEL: BEGIN
    -- Insert the stall (WITHOUT stall_image column)
    INSERT INTO stall (
        stall_no, 
        stall_location, 
        size, 
        ...
        stamp, 
        description, 
        -- stall_image REMOVED - now using stall_images table
        is_available,
