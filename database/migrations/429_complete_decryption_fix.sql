-- =============================================
-- 429: COMPLETE DECRYPTION FIX FOR ALL USER TYPES
-- Fixes: collector creation, inspector/collector/manager/employee decryption
-- =============================================

-- =============================================
-- PART 1: Fix sp_createCollectorDirect (fixes 500 error)
-- =============================================
...
-- =============================================
-- PART 2: Fix sp_createInspectorDirect
-- =============================================
...
-- =============================================
-- PART 3: Encrypt existing inspector/collector data
-- =============================================
...
-- =============================================
-- PART 4: MOBILE - Inspector login decryption
-- =============================================
...
-- =============================================
-- PART 5: MOBILE - Collector login decryption
-- =============================================
...
-- =============================================
-- PART 6: WEB - Branch Manager profile decryption
-- =============================================
...
-- =============================================
-- PART 7: WEB - Business Employee decryption procedures
-- =============================================
...
DELIMITER $$
CREATE PROCEDURE `getBusinessEmployeesByBranch`(IN p_branch_id INT, IN p_status VARCHAR(20))
BEGIN
    DECLARE v_key VARCHAR(255);
...
-- =============================================
-- PART 8: WEB - Business Manager login decryption
-- =============================================
...
-- =============================================
-- PART 9: WEB - sp_getBranchManagerByUsername decryption
-- =============================================
DROP PROCEDURE IF EXISTS `sp_getBranchManagerByUsername`;

DELIMITER $$
CREATE PROCEDURE `sp_getBranchManagerByUsername`(IN p_username VARCHAR(100))
BEGIN
    DECLARE v_key VARCHAR(255);
    ...
    SELECT 
        bm.branch_manager_id,
        bm.branch_id,
        bm.manager_username as username,
        bm.manager_password_hash as password_hash,
        CASE 
            WHEN bm.is_encrypted = 1 AND bm.encrypted_first_name IS NOT NULL 
            THEN CAST(AES_DECRYPT(bm.encrypted_first_name, v_key) AS CHAR(100))
            ELSE bm.first_name 
...
-- =============================================
-- PART 10: WEB - sp_getBusinessEmployeeByUsername (for login)
-- =============================================
...
-- =============================================
-- PART 11: MOBILE - sp_getInspectorById decryption
-- =============================================
DROP PROCEDURE IF EXISTS `sp_getInspectorById`;

DELIMITER $$
CREATE PROCEDURE `sp_getInspectorById`(IN p_inspector_id INT)
BEGIN
    DECLARE v_key VARCHAR(255);
...
-- =============================================
-- PART 12: MOBILE - sp_getCollectorById decryption
-- =============================================
DROP PROCEDURE IF EXISTS `sp_getCollectorById`;

DELIMITER $$
CREATE PROCEDURE `sp_getCollectorById`(IN p_collector_id INT)
BEGIN
    DECLARE v_key VARCHAR(255);
...
-- =============================================
-- PART 13: WEB - getAllInspectors decryption
-- =============================================
DROP PROCEDURE IF EXISTS `sp_getAllInspectors`;

DELIMITER $$
CREATE PROCEDURE `sp_getAllInspectors`()
BEGIN
    DECLARE v_key VARCHAR(255);
...
-- =============================================
-- PART 14: WEB - getAllCollectors decryption
-- =============================================
...
SELECT '✅ Migration 429 complete! All decryption procedures updated.' as status;
