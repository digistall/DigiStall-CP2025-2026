-- Fix sp_getAllStalls_complete to support stall_business_owner role
-- Business owners should see stalls from ALL branches they own through their managers
...
SELECT 'sp_getAllStalls_complete updated to support stall_business_owner!' as Result;
