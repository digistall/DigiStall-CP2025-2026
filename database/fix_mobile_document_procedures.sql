-- Fix Stallholder Documents Stored Procedures for New Table Structure
-- This updates the procedures to use the new document_types structure
...
-- Updated to use new table structure with type_name
-- =====================================================
...
SELECT 'Stored procedure sp_getBranchDocRequirementsFull updated successfully' as Status;
