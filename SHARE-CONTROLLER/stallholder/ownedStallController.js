    ...
    for (const stall of rawStalls) {
      ...
      if (stall.stall_id) {
        try {
          ...
          console.log('⚠️ Could not fetch stall image for stall_id:', stall.stall_id);
        }
      }
      ...
      if (stall.stallholder_id) {
        try {
          ...
          console.log('⚠️ Could not fetch payment info for stallholder_id:', stall.stallholder_id);
        }
      }
