/**
 * Fix Missing Procedures Script
 * Fixes: getViolationHistoryByStallholder and sp_getDocumentsByStallholderId
 * Run this script to create/fix missing stored procedures
 */
