...
// ===== MVC ROLE-BASED ARCHITECTURE =====
// All views imported from role folders

// BUSINESS_OWNER Views
import LoginPage from '@BUSINESS_OWNER/Login/LoginPage.vue'
import Dashboard from '@BUSINESS_OWNER/Dashboard/Dashboard.vue'
import Payment from '@BUSINESS_OWNER/Payment/Payment.vue'
import Complaints from '@BUSINESS_OWNER/Complaints/Complaints.vue'
import Compliances from '@BUSINESS_OWNER/Compliances/Compliance.vue'
import Stallholders from '@BUSINESS_OWNER/Stallholders/Stallholders.vue'
import Stalls from '@BUSINESS_OWNER/Stalls/Stalls.vue'
import MySubscription from '@BUSINESS_OWNER/Subscription/MySubscription.vue'

// BRANCH_MANAGER Views
import BranchManagement from '@BRANCH_MANAGER/Branch/Branch.vue'

// EMPLOYEE Views
import Employees from '@EMPLOYEE/Employees/Employees.vue'

// VENDOR Views
import Vendors from '@VENDOR/Vendors/Vendors.vue'

// APPLICANTS Views
import Applicants from '@APPLICANTS/Applicants/Applicants.vue'

// SYSTEM_ADMIN Views
import SystemAdminDashboard from '@SYSTEM_ADMIN/Dashboard/SystemAdminDashboard.vue'
import BusinessOwners from '@SYSTEM_ADMIN/BusinessOwners/BusinessOwners.vue'
import Payments from '@SYSTEM_ADMIN/Payments/Payments.vue'
import Reports from '@SYSTEM_ADMIN/Reports/Reports.vue'

// PUBLIC Views
import LandingPage from '@PUBLIC/LandingPage.vue'

// Shared Components (from FRONTEND-WEB/src/components)
