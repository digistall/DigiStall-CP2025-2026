              ...
              >
                ...
                <td class="name-cell">
                  <div class="stallholder-info">
                    ...
                    <span class="clickable-name name" @click.stop="showStallholderDetails(stall.id)">{{ stall.name || 'N/A' }}</span>
                  </div>
                </td>
              ...
              <div class="detail-cards-wrapper">
                ...
                <div class="detail-card stallholder-card">
                  ...
                  <div class="stallholder-card-content">
                    ...
                    <span class="clickable-name detail-card-value stallholder-name-value" @click="showStallholderDetails(selectedStall.id)">
                      {{ selectedStall.name }}
