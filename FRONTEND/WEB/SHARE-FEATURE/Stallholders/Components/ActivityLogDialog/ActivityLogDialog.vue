          ...
          <div class="header-content">
            <div class="header-left">
              ...
              <div class="header-text">
                <span class="header-title">Stallholder Activity Log</span>
                <div class="header-subtitle">Monitor all stallholder activities across the system</div>
              </div>
            </div>
      ...
      <v-card-text class="clear-dialog-content">
        <div class="warning-section">
          ...
          <p class="warning-text mb-4">
            This action will permanently delete all activity log records for this stallholder.
          </p>
        </div>
