...

    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: 'Complaints', hasTable: true },
        ...
        },
        {
          ...
          name: 'Payment',
          component: Payment,
          meta: { title: 'Payment', hasTable: true },
        ...
        },
        {
          ...
          meta: { title: 'Applicants', hasTable: true },
        ...
        },
        {
          ...
          meta: { title: 'Compliances', hasTable: true },
        ...
        },
        {
          ...
          meta: { title: 'Stallholders', hasTable: true },
        ...
        },
        {
          ...
          name: 'Stalls',
          component: Stalls,
          meta: { title: 'Stalls', hasTable: true },
        ...
        },
        {
          ...
          meta: { title: 'Stall Tracker', hasTable: true },
    ...
    // System Administrator Routes
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: 'Business Owners Management', requiresRole: ['system_administrator'], hasTable: true },
        },
        {
          path: 'payments',
          name: 'SubscriptionPayments',
          component: Payments,
          meta: { title: 'Subscription Payments', requiresRole: ['system_administrator'], hasTable: true },
        },
        {
          path: 'reports',
          name: 'SubscriptionReports',
          component: Reports,
          meta: { title: 'Subscription Reports', requiresRole: ['system_administrator'], hasTable: true },
        },
        {
          path: 'profile',
